...
export default function NotificacionComponent({ Notifications, onClose }: NotificationProps) {
    ...
    const icon = Notifications.tipo === 'error'
    ...
    return (
        <motion.div
            ...
            className="fixed bottom-4 right-4 bg-(--color-glacier-50) p-4 rounded-lg shadow-lg flex items-center space-x-4 z-[100]"
        >
            {icon}
            <div className="text-(--color-glacier-950)">
