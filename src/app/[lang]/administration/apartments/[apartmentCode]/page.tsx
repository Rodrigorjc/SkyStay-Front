...
export default function HotelsDetails() {
  ...
  }, [apartmentCode, dict.ADMINISTRATION.ERRORS.LOAD_FAILURE_TITLE, dict.ADMINISTRATION.ERRORS.LOAD_FAILURE_MESSAGE]);
      ...
      <div className="mx-auto max-w-screen-xl space-y-12">
        ...
        {apartment.image && (
          <section>
            ...
            <Image src={apartment.image} alt={apartment.name} width={288} height={288} className="w-full h-72 object-cover rounded-xl shadow-md border border-zinc-700" />
          </section>
        )}
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {!roomType.image ? (
                    ...
                    <section className="w-full mb-2">
                      <h2 className="text-xl font-semibold text-glacier-400 font-mono uppercase mb-4">{dict.ADMINISTRATION.HOTEL_DETAILS.IMAGE}</h2>
                      <Image src={roomType.image} alt={`${roomType.roomType} image`} width={288} height={288} className="w-full h-72 object-cover rounded-xl shadow-md border border-zinc-700" />
                    </section>
                  )}
                </div>
